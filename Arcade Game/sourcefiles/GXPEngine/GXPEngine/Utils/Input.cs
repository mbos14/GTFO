...
namespace GXPEngine
{
    ...
    public class Input
    {
        ...
        /// <summary>
        /// Returns 'true' if any key was pressed during the current frame
        /// </summary>
        public static bool GetAnyKeyDown()
        {
            return GLContext.GetAnyKeyDown();
        }

        /// <summary>
        /// Returns the key what was pressed during the current frame
        /// </summary>
        public static char GetPressedKeyDown()
        {
            return GLContext.GetPressedKeyDown();
        }
        ...
        {
            return GLContext.GetMouseButtonUp(button);
        }
