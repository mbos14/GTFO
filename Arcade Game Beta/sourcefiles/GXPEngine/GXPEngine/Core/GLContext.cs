...
namespace GXPEngine.Core
{
    ...
    public class GLContext
    {
        ...
        private static bool[] mouseup = new bool[MAXBUTTONS + 1];
        ...
        {
            foreach (bool key in keydown)
            { // Loop over all keys, there will be better ways of doing this!
                if (key)
                {
                    return true; // Don't return if key is false!
                }
            }
        ...
        //														GetPressedKeyDown()
        //------------------------------------------------------------------------------------------------------------------------
        public static char GetPressedKeyDown()
        {
